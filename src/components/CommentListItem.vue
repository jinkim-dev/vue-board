    ...
    <div>
        <div class="comment-list-item">
            ...
            <div class="comment-list-item-button">
                ...
                <b-button variant="info" @click="subCommentCreateToggle">덧글 쓰기</b-button>
            </div>
        </div>
        <template v-if="subCommentToggle">
            <CommentCreate :isSubComment="true" :commentId="commentObj.comment_id" :subCommentToggle="subCommentCreateToggle" :reloadSubComment="reloadSubComment" />
        </template>
...
export default {
    ...
    data() {
        return {
            ...
            subCommentToggle: false
        }
    },
    methods: {
        subCommentCreateToggle() {
            this.subCommentToggle = !this.subCommentToggle
        },
        reloadSubComment() {
